...
// FIX: Add missing constants for Night City Legends to resolve import errors.
...
// FIX: Replaced with the user's provided backup version.
export const NIGHT_CITY_LEGENDS = {
    ...
    '華森 (Watson)': [
        ...
        { name: 'NID的碼頭走私', prompt: 'A nighttime smuggling operation at the Northside Industrial District docks, with heavy cargo being loaded under the cover of darkness.' },
    ],
    '西流區 (Westbrook)': [
        ...
        { name: 'Charter Hill的豪華派對', prompt: 'An exclusive rooftop party in a Charter Hill penthouse, overlooking the glittering expanse of Night City.' },
        { name: '北橡區的秘密潛入', prompt: 'A stealthy infiltration of a celebrity\'s heavily guarded mansion in the hills of North Oak.' },
    ],
    '市政中心 (City Center)': [
        { name: '市中心商業區的飛車追逐', prompt: 'A high-speed car chase weaving through the dense traffic and towering skyscrapers of the Downtown commercial district.' },
        { name: '公司廣場地鐵站的伏擊', prompt: 'An ambush taking place in the crowded, multi-level Corpo Plaza metro station.' },
    ],
    '海伍德 (Heywood)': [
        ...
        { name: 'Wellsprings的情報交換', prompt: 'An intelligence exchange happening at a fancy cafe in the affluent Wellsprings district.' },
    ...
    '聖多明哥 (Santo Domingo)': [
        ...
        { name: 'Rancho Coronado的郊區衝突', prompt: 'A suburban conflict in Rancho Coronado, with armored vehicles rolling down residential streets.' },
    ],
    '惡地 (Badlands)': [
